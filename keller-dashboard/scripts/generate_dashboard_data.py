...
DELIVERABLES = [
    {
        ...
        "status": "inputs_gathering",
        "target_date": "2026-05-01",
        "depends_on": [],
        "notes": "Technology.md heavily populated. Need Tim's systems access to complete.",
        "inputs_needed": [
            {"label": "Tim Trumbo tool audit sessions", "type": "interview", "available": True},
            ...
            {"label": "Deltek ecosystem research", "type": "research", "available": True},
            {"label": "Copilot capabilities deep dive", "type": "research", "available": False},
    ...
    },
    {
        ...
        "target_date": "2026-05-01",
        "depends_on": [],
        "notes": "People.md and Culture.md heavily populated. Baseline survey analyzed.",
        "inputs_needed": [
            {"label": "All Wave 2 interviews extracted", "type": "interview", "available": False},
            ...
            {"label": "Wave 3 targeted follow-ups", "type": "interview", "available": False},
        ],
    },
    {
        "id": 3,
        ...
        "target_date": "2026-05-01",
        "depends_on": [],
        "notes": "Workflows.md is the most populated analysis doc (~92KB).",
        "inputs_needed": [
            {"label": "Workflows.md analysis doc", "type": "analysis", "available": True},
            {"label": "AEC AI plan review tools research", "type": "research", "available": False},
            {"label": "All department interviews extracted", "type": "interview", "available": False},
    ...
    },
    {
        ...
        "depends_on": [1, 2, 3],
        "notes": "Can't start until Tech Audit, Readiness Assessment, and Workflow Map are drafted.",
        "inputs_needed": [
    ...
    },
    {
        ...
        "target_date": "2026-05-05",
        "depends_on": [2],
        "notes": "Scaffold exists at Analysis/Deliverables/Training_Program_Scaffold.md",
        "inputs_needed": [
            {"label": "Readiness Assessment (draft)", "type": "other", "available": False},
            {"label": "Department-level skill gaps identified", "type": "analysis", "available": False},
            {"label": "Copilot capabilities confirmed", "type": "research", "available": False},
        ],
    },
    {
        "id": 6,
        ...
        "inputs_needed": [
            {"label": "Culture.md analysis doc", "type": "analysis", "available": True},
            {"label": "Champions/early adopters identified", "type": "analysis", "available": True},
            {"label": "Readiness Assessment (draft)", "type": "other", "available": False},
            {"label": "Adoption patterns from interviews", "type": "interview", "available": True},
        ],
    },
    {
        "id": 7,
        ...
        "depends_on": [4],
        "notes": "2:15 PM at JUMP Level 4, INSPIRE Studio. Top Golf dinner after.",
        "inputs_needed": [
            {"label": "Implementation Roadmap (draft)", "type": "other", "available": False},
            {"label": "Larry review session (~Apr 30)", "type": "other", "available": False},
            {"label": "Presentation deck created", "type": "other", "available": False},
